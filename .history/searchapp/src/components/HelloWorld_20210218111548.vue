...
<v-row >
   <v-col lg="10">
    ...
    <v-btn id="btn" outlined @click="klik" class="mt-4"><v-icon><span class="iconify" data-icon="mdi-list-status" data-inline="false"></span></v-icon></v-btn>
                    ...
                    <v-col id="image"  lg="4" xs="2" >
                      <img  style="border-radius: 2%" class="ml-8" :src="arr.poster" />
                        ...
                        <v-col  id="text" lg="8" xs="2" cols="6" >
                          <span  id="demo"> Aktorzy:</span> <span class="font-weight-bold"> {{ arr.actors}}</span>
                          <p></p>
