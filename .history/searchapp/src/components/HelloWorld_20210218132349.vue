...
<v-row >
   <v-col lg="10">
            ...
            <v-text-field ref="value"  clearable placeholder="Wpisz tytuł film/serialu" type="text" class="ml-4"  lg="2" xs="0"  v-model="input"></v-text-field>
                ...
                <p  id="text1" >{{arr.title}}</p>
                  ...
                  <v-row >
                    <v-col id="image"  lg="4" xs="1" >
                      <img  style="border-radius: 2%" class=" d-flex justify"  :src="arr.poster" />
                    </v-col>
