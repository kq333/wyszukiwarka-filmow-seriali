...
<v-row >
   <v-col lg="10">
    ...
    <v-btn id="btn" outlined @click="klik" class="mt-4"><v-icon>search </v-icon></v-btn>
                    ...
                    <v-col id="image"  lg="4" xs="2" >
                      <img  style="border-radius: 2%" class="ml-8" :src="arr.poster" />
                        ...
                        <v-col  id="text" lg="8" xs="2" cols="6" >
                          <span  id="demo"> Aktorzy:</span> <span style=" font-size:1rem" class=" grey--text"> {{ arr.actors}}</span>
                          <p></p>
