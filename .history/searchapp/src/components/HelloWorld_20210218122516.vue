...
<v-row >
   <v-col lg="10">
            ...
            <v-text-field ref="value"  clearable placeholder="Wpisz tytuł film/serialu" type="text" class="ml-4"  v-model="input"></v-text-field>
                ...
                <p  id="text1"  class="mx-12" style="font-size:38px">{{arr.title}}</p>
                  ...
                  <v-row >
                    <v-col id="image"  lg="4" xs="2" >
                      <img  style="border-radius: 2%" class="ml-4" :src="arr.poster" />
                    </v-col>
