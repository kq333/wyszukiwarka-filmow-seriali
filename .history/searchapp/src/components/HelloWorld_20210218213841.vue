                  ...
                  <v-row >
                    <v-col id="image"  lg="4" xs="1"  >
                      <img id="img" style="border-radius: 2%"  :src="arr.poster" />
                        ...
                        <v-col  id="text" lg="7" xs="2" cols="6" class="ml-7">
                          <span  id="demo"> Aktorzy:</span> <span class="item"  > {{ arr.actors}}</span>
                          <p></p>

                          <span> Reżyseria:</span> <span class="item">{{arr.director}}</span>
                          <p></p>
                          <span>Kraj: </span><span class="item">{{arr.country}}</span>
                          <p></p>
                          <span>Rok produkcji: </span><span class="item">{{arr.released}}</span>
                          <p></p>
                          <span>Gatunek: </span><span class="item">{{arr.genre}}</span>
                          <p></p>
                          <span>Opis: </span><span class="item">{{arr.plot}}</span>
                          <p></p>
                          <span>Ranking IMDB: </span><span class="item">{{arr.imdb}}</span>
                        </v-col>
                  </v-row>
